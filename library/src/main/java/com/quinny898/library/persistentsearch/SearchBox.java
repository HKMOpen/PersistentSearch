...
public class SearchBox extends RelativeLayout {
    ...
    private void init() {
        ...
        overflow.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (searchOpen) {
                    toggleSearch();
                    //  Animation n = new RotateAnimation(0f, 360f, Animation.RELATIVE_TO_SELF, 0f, Animation.RELATIVE_TO_SELF, 0f);
                    //  n.setInterpolator(new LinearInterpolator());
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR1) {
                        overflow.animate().rotationBy(90f);
                    }
                } else {
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.length() > 0) {
                    ...
                    mic.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_tech_close));
                    updateResults();
                } else {
                    micStateChanged(true);
                    mic.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_action_mic));
   ...
   /* public void setDrawerLogo(Drawable icon) {
     ...
     *
     * @param searchables the array to be list
     */
    ...
    public void setInputBackPressToHide(boolean b) {
        this.input_back_press_hide = b;
    }
    ...
    private void reveal() {
        if (mContainerActivity == null) return;
        final FrameLayout layout = (FrameLayout) mContainerActivity.getWindow().getDecorView().findViewById(android.R.id.content);
        revealFrom(layout.getLeft() + layout.getRight(), layout.getTop(), mContainerActivity, this);
    }

    private void hideCirular() {
        if (mContainerActivity == null) return;
        hideCircularly(this.mContainerActivity);
    }

    /**
     * this function should be triggered by key press
     *
     * @param b the press for rather it should be up or down
     */
    ...
    public boolean dispatchKeyEvent(KeyEvent e) {
        if (input_back_press_hide && e.getKeyCode() == KeyEvent.KEYCODE_BACK && getVisibility() == View.VISIBLE) {
    ...
    public interface SearchListener {
         ...
         *
         * @param term string of the result
         */
    ...
    public interface SearchFilter {
         ...
         *
         * @param searchResult result object
         * @param searchTerm   string object
         * @return the bool
         */
